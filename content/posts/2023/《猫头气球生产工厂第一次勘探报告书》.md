...
### waline评论区
#### 更新版本
1. 修改github对应仓库中`package.json`文件中`@waline/vercel`版本号为最新
2. 需要更改hugo文件中`layouts\partials\comments\cactus_comments.html`
```
<head>
...
```
#### 关闭自带的ip和操作系统显示
在{{<mark text= "vercel">}}中添加环境变量（settings-environment variety）
<br>
|Key|Value|
|:----:|:----:|
|DISABLE_REGION|ture
...
**配置完之后记得找个最近的deploy右键redeploy一下**<br/>
**key一定要大写**
...
<div class="open-heart-section">
 ...
 {{<  neodb "https://neodb.social/book/5RR3pJjBmh5PE593wAZR6B" "2(评分)" >}}
